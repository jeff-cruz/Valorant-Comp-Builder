  ...
  if (event.target.tagName === 'IMG') {
    ...
    xhr.addEventListener('load', function () {
      ...
      if (xhr.response.data[i].isPlayableCharacter === true) {
        ...
        $abilityOneIcon.setAttribute('class', 'ability');
        ...
        $abilityOneText.setAttribute('class', 'ability-description');
        ...
        $abilityTwoIcon.setAttribute('class', 'ability');
        ...
        $abilityTwoText.setAttribute('class', 'ability-description');
        ...
        $abilityThreeIcon.setAttribute('class', 'ability');
        ...
        $abilityThreeText.setAttribute('class', 'ability-description');
        ...
        $abilityFourIcon.setAttribute('class', 'ability');
        ...
        $abilityFourText.setAttribute('class', 'ability-description');
